            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              <ACard>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                  <span title="Recommendations come from your crop guides, companion-planting library, and extension-service timing rules. Click any item to schedule it as a task.">
                    <AKicker>Recommended · from crop guides</AKicker>
                  </span>

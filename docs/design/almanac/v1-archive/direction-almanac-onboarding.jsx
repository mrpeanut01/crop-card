            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <A_Card style={{ borderColor: A.forest, borderLeft: `4px solid ${A.forest}` }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    <div className="serif" style={{ fontSize: 14, color: A.forestDeep, fontWeight: 600 }}>Planning assistant</div>
                    <div style={{ fontSize: 10.5, color: A.inkMuted }}>can pre-populate from a sample farm</div>
                  </div>
                </div>
                <p style={{ margin: "0 0 12px", fontSize: 12.5, color: A.inkSoft, lineHeight: 1.5 }}>
                  Want me to seed a small-plot example so you can poke around before committing real data? I'll mirror your
                  county's frost dates and pick 3-5 starter crops from the 308 supported plugins.
                </p>
                <button style={{ ...A_primaryBtn, width: "100%", justifyContent: "center", padding: "10px 14px" }}>
                  <Icon.Sprout size={13} /> Yes, seed a sample plan
                </button>
                <button style={{ ...A_ghostBtn, width: "100%", marginTop: 8, justifyContent: "center", padding: "8px 12px" }}>
                  No thanks — I'll enter my own
                </button>
              </A_Card>

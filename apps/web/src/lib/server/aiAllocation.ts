  ...
  return {
    ...
    rationale:
      reason === 'no-api-key'
        ...
        : reason === 'over-cap'
          ? "Plan generated by the deterministic engine (this month's AI help is used up; it resets on the 1st)."
          : reason === 'quota-exceeded'
            ? "Plan generated by the deterministic engine (today's AI planning limit is used up; it resets at midnight UTC)."
